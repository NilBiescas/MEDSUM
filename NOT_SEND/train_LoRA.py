...
model_name = 'LoRA_Only_SyntheticData'
...
def preprocess_function(examples):
    ...
    reports_input = tokenizer(reports, max_length=2000, truncation=True, padding=False)
...
peft_config = LoraConfig(
    task_type=TaskType.SEQ_2_SEQ_LM, inference_mode=False, r=8, lora_alpha=22, lora_dropout=0.2
)
