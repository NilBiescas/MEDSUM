...
"""
Code to generate summaries in Spanish with OpenAi API using the model gpt-3.5-turbo-0125. 
It uses one examples from the Asho dataset to generate summaries in Spanish for the rest of data.
"""
API_KEY = ""
...
try:
    for idx,text in enumerate(texts2summarize):        
        ...
        # Generate the summaries with the API
