...
"""
Code to finetune FLOR-760M to the synthetic dataset generated with LLAMA3-70B
"""

model_name_finetune = 'train_Medical_newdata_without_LoRA'
...
model = BloomForCausalLM.from_pretrained(checkpoint, attention_dropout=0.2, hidden_dropout=0.2).to("cuda:0")
