...
"""
Code to finetune FLOR-760M to the synthetic dataset generated with LLAMA3-70B in a two-step process, with the weights of the word embeddings frozen.
...
model_name_finetune = 'NO_LoRA_Finetune_MedicalReports_v2'
